...
def op_initialize_project_dir(self):
    tools.Logging.set_project_logger().info("Initializing project directory")
    ...
    tools.Logging.set_project_logger().info("Completed initializing project directory")


def op_browser_project_dir(self):
    tools.Logging.set_project_logger().info("Browsing project directory")
    ...
    self.txt_proj_dir.lineedit.setText(_target_dir)
    self.txt_proj_dir.lineedit.setCursorPosition(0)
    tools.Logging.set_project_logger().info("Completed browsing project directory")
