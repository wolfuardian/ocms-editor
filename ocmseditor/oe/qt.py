...
class QtFrameLayoutCSWidget(QtDefaultCSWidget):
    ...
    def __on_isolated(self):
        """Hide all items in layout except _FrameButton"""
    ...
    def set_isolated_action(self, action):
        """Set the action of _FrameButton"""
...
class QtFrameButtonCSWidget(QtDefaultCSWidget):
    ...
    def __init__(self, label=None, parent=None, status=None):
        ...
        self.__isolate_btn.set_status(QtButtonStatus.Transparent)
        self.__isolate_btn.clicked.connect(lambda: self.__isolated.emit())
        layout.addStretch()
        layout.addWidget(self.__isolate_btn)
        ...
        # self.__isolated.listen.add(lambda: self.toggle(True))
    ...
    def isolated(self):
        """
        Register function when FrameLayout is isolated
        """
